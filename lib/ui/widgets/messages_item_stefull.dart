...
class MessagesItemSteful extends StatefulWidget {
  final Message message;

  final bool isUserMassage;

  //MessagesItem(this._message, this.isUserMassage);
  const MessagesItemSteful({Key key, this.message, this.isUserMassage})
      : super(key: key);
  @override
...
class _CoursesDetailScreenState extends State<MessagesItemSteful> {
  Message _message;
  var bytes = [];
  bool isUserMassage;
  @override
