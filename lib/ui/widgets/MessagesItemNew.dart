...
class MessagesItemNew extends StatefulWidget {
  final Message message;

  final bool isUserMassage;

  //MessagesItem(this._message, this.isUserMassage);
  const MessagesItemNew({Key key, this.message, this.isUserMassage})
      : super(key: key);

  @override
  StateMessagesItemNew createState() => StateMessagesItemNew();
}

class StateMessagesItemNew extends State<MessagesItemNew> {
  Message _message;
  String urlVideo = "";
  var bytes = [];
  bool isUserMassage;
  ...
  void initState() {
    ...
    isUserMassage = widget.isUserMassage;
    super.initState();
